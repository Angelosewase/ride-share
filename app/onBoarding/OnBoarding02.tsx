...
const OnBoardin01 = () => {
  ...
  return (
    <SafeAreaView className='flex-1  items-center '>
        ...
        <Image source={require("@/assets/ride_share/At anytime.png")} style={styles.image} className='mt-[100px]'/>
        ...
        <TouchableOpacity className='mb-20' onPress={()=> router.navigate('/onBoarding/OnBoarding03')}>
          <Image source={require('@/assets/ride_share/Group 297.png')} />
        </TouchableOpacity>
    </SafeAreaView>
  )
}
